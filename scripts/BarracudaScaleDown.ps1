...
if($ServerType -eq "VMSS")
{
    ...
    $ids | % {
    Stop-AzVmss -ResourceGroupName $rg -VMScaleSetName $vmssname -InstanceId $InstanceId[$_] -Force -Verbose -AsJob
...
if($ServerType -eq "VM")
{
    ...
    Stop-AzVM -Name $_ -ResourceGroupName $rg -Force -Verbose -AsJob
    }    
}
